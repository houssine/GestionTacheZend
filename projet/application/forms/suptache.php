...
class Application_Form_suptache extends Zend_Form
{
...
*/
        		...
        		$this -> setMethod('POST');
        		 $this -> setAction('http://localhost/projet/public/chefprojet/suptache'); // actioooooooooooon
                

$this->addElement('text','description_tache',array(
                'label' =>'Le nom de la tache : ',
                'required' => 'true',
                'Filter' =>array('StringTrim')
        	));
